...
class TimetableGeneratorService {
  ...
  List<String> _extractTeacherSubjects(dynamic staff) {
  ...
  List<String> _extractUnavailableSlots(dynamic staff) {
  ...
  List<String> _extractPreferredSlots(dynamic staff) {
  ...
  Map<String, dynamic> _extractConstraints(Map<String, dynamic> constraints) {
    final extractedConstraints = <String, TimetableConstraint>{};
    final conflicts = <TimetableConflict>[];
  ...
  List<String> _extractSubjectPrerequisites(String subjectId, Map<String, TimetableConstraint> constraints) {
  ...
  double _calculateFeasibilityScore(List<TimetableConflict> conflicts, int teacherCount, int subjectCount) {
  ...
  List<Map<String, dynamic>> _buildAssignmentGraph({
    required List<String> subjects,
    required List<String> teachers,
    required List<String> timeSlots,
    required List<String> days,
  ...
  List<Map<String, dynamic>> _graphColoringHeuristic(List<Map<String, dynamic>> assignments) {
  ...
  int _calculateNodeDegree(Map<String, dynamic> node, List<Map<String, dynamic>> otherNodes) {
    int degree = 0;
  ...
  List<Map<String, dynamic>> _getAvailableTeachersForSlot({
  ...
  Map<String, dynamic>? _forwardCheck(
    int startIndex,
  ...
  List<String> _getPreferredTimeSlots(String subject, Map<String, TimetableConstraint> constraints) {
    final constraint = constraints['subject_$subject'];
    return constraint?.preferredTimeSlots ?? [];
  }

  int _calculateAssignmentPriority(String subject, String slot, Map<String, TimetableConstraint> constraints) {
    int priority = 0;
  ...
  Map<String, dynamic> _getAssignmentConstraints(String subject, String slot, Map<String, TimetableConstraint> constraints) {
    return {
      'subject': subject,
      'slot': slot,
  ...
  List<Map<String, dynamic>> _sortTeachersByConstraint(
  ...
  Map<String, Map<String, ScheduledLesson>> _convertAssignmentsToTimetable(
  ...
  TimetableConflict? _checkAssignmentConstraints({
    required String subject,
  ...
  Map<String, dynamic> _solveCSP({
    ...
    // Try to assign each subject using backtracking
    bool _assignSubject(String subject, int startIndex) {
    ...
    for (final subject in prioritizedSubjects) {
      final assigned = _assignSubject(subject, 0);
      if (!assigned) {
        conflicts.add(TimetableConflict(
          type: 'subject',
  ...
  List<String> _prioritizeSubjects(List<String> subjects, Map<String, dynamic> requirements) {
  ...
  bool _isCoreSubject(String subject, Map<String, dynamic> requirements) {
  ...
  bool _isPracticalSubject(String subject, Map<String, dynamic> requirements) {
  ...
  Map<String, dynamic>? _findBestAvailableTeacher({
    required String subject,
    required String day,
    required String slot,
    required List<String> teachers,
  ...
  bool _wouldExceedConsecutivePeriods({
    required String teacherId,
    required String day,
    required String slot,
    required Map<String, Map<String, ScheduledLesson>> currentTimetable,
  ...
  List<TimetableConflict> _validateTeacherConflicts({
    required Map<String, Map<String, ScheduledLesson>> timetable,
    required Map<String, TimetableConstraint> constraints,
    required List<String> teachers,
    required List<String> timeSlots,
  ...
  List<TimetableConflict> _validateRoomConflicts({
    required Map<String, Map<String, ScheduledLesson>> timetable,
    required List<String> timeSlots,
    required List<String> days,
    required Map<String, dynamic> statistics,
  ...
  List<TimetableConflict> _validateSubjectDistribution({
    required Map<String, Map<String, ScheduledLesson>> timetable,
    required List<String> subjects,
    required Map<String, TimetableConstraint> constraints,
    required Map<String, dynamic> requirements,
  ...
  List<TimetableConflict> _validateConstraintCompliance({
    required Map<String, Map<String, ScheduledLesson>> timetable,
    required Map<String, TimetableConstraint> constraints,
    required List<String> teachers,
    required List<String> timeSlots,
  ...
  List<TimetableConflict> _validateWorkloadBalance({
    required Map<String, Map<String, ScheduledLesson>> timetable,
    required Map<String, TimetableConstraint> constraints,
    required List<String> teachers,
    required List<String> days,
  ...
  Map<String, dynamic> _generateConflictSummary(List<TimetableConflict> conflicts) {
  ...
  List<Map<String, dynamic>> _checkConsecutivePeriods({
    ...
    for (final slot in sortedSlots) {
      final hasAssignment = dayAssignments.any((assignment) => {
        // Check if assignment matches this slot (simplified check)
      });
