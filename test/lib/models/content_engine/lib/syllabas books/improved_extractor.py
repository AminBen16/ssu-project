#!/usr/bin/env python3
"""
Improved NCDC Syllabus Data Extraction Script
Algorithmic approach for maximum accuracy and recall
"""
...
class ImprovedNCDCExtractor:
    def __init__(self, base_dir: str = "C:/Users/user/SSU"):
        ...
        self.knowledge_verbs = {
            ...
            'know', 'understand', 'appreciate', 'comprehend'
        }
    ...
    def extract_class_with_context(self, content: str, section_start: int = 0) -> str:
        """Extract class information using context-aware algorithms"""
    ...
    def create_structured_entry_enhanced(self, file_path: Path, topic_data: Dict) -> Dict:
    ...
    def process_all_files_enhanced(self) -> Dict[str, Any]:
        ...
        print("Processing A-Level files with enhanced algorithm...")
        ...
        print("\nProcessing O-Level files with enhanced algorithm...")
    ...
    def run_enhanced(self):
        """Run enhanced extraction process"""
        print("🚀 Starting Enhanced NCDC Syllabus Extraction...")
        print("=" * 60)
        print("Improvements:")
        print("- Enhanced outcome type classification")
        print("- Better context-aware class detection")
        print("- Improved learning outcome extraction")
...
def main():
    extractor = ImprovedNCDCExtractor()
    results = extractor.run_enhanced()
